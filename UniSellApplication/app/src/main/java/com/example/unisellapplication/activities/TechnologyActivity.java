...
public class TechnologyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager( TechnologyActivity.this);
    ...
    private void searchProduct(String inText) {
        ...
        if(!inText.isEmpty()){
            ...
            if(filteredList.isEmpty()){
                Toast.makeText(TechnologyActivity.this, "Search results not found", Toast.LENGTH_SHORT).show();
            }
            else {
